...
func init() {
	...
	utilruntime.Must(cronjobmanagerv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "60c380d5.varu3.me",
	})
	if err != nil {
	...
	if err = (&controllers.CronJobManagerReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "CronjobManager")
		os.Exit(1)
	}
